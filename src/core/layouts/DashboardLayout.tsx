  ...
  useEffect(() => {
    const loadProfilePhoto = async () => {
      try {
        ...
        const response = await fetch('https://tis-back-production.up.railway.app/api/usuarios/perfil', {
          method: 'GET',
          headers: {
  ...
  useEffect(() => {
    const fetchShareUrl = async () => {
      try {
        ...
        const response = await fetch('https://tis-back-production.up.railway.app/api/enlace/mi-enlace-publico', {
          method: 'POST',
          headers: {
            'Content-Type': 'application/json',
